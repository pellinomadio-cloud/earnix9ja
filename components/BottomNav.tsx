          ...
          return (
            ...
            >
              {isActive && tab.id === 'home' ? (
                 <div className="bg-gold rounded-full p-1 mb-1 shadow-md">
                    <Icon size={20} className="text-black" />
                 </div>
              ) : isMeAndHasImage ? (
                <div className={`w-7 h-7 rounded-full overflow-hidden mb-1 border-2 ${isActive ? 'border-gold' : 'border-transparent'}`}>

    ...
    <div className="px-4 py-6 space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-gray-900 rounded-2xl shadow-sm border border-gray-800 overflow-hidden">
        <div className="divide-y divide-gray-800">
            ...
            {user.isSubscribed && (
                 <div className="p-4 bg-gold/10 flex items-center justify-between border-b border-gold/20">
                    <div className="flex items-center space-x-3">
                        <div className="w-10 h-10 rounded-full bg-gold text-black flex items-center justify-center shadow-md shadow-gold/20">
                ...
                transactions.map((trx) => (
                    ...
                    >
                        ...
                        <div className="text-right flex items-center space-x-3">
                            ...
                            <Icons.ChevronRight size={16} className="text-gray-700 group-hover:text-gold transition-colors" />
                        </div>
                    </div>
                ))
            ) : (
      ...
      {!user.isSubscribed && transactions.length === 0 && (
        <div className="bg-gold/5 border border-gold/10 p-4 rounded-xl flex items-start space-x-3">
            <Icons.FileText className="text-gold mt-0.5" size={20} />
            <div className="flex-1">
                <p className="text-sm font-bold text-gold">Start Transacting</p>

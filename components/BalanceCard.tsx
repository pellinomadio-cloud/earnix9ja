...
const BalanceCard: React.FC<BalanceCardProps> = ({ balance, isSubscribed = false, onAdminClick, onHistoryClick }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-gold-light via-gold to-gold-dark rounded-2xl p-4 mb-4 relative overflow-hidden transition-all duration-500 border border-gold-dark shadow-gold-lg group">
        ...
        <div className="relative z-10">
            ...
            <div className="flex justify-between items-end">
                ...
                <button 
                    ...
                    className="bg-black hover:bg-gray-900 text-gold px-4 py-2 rounded-full text-xs font-bold shadow-lg active:scale-95 transition-all"
                >
                    Transaction History
                </button>
            </div>
            ...
            <div className="mt-4 pt-2 border-t border-black/10 flex justify-between items-center">
                <p className="text-xs text-black/80 font-medium flex items-center">
                    <span className="bg-black text-gold text-[10px] px-1 rounded mr-2 font-bold">10</span>
